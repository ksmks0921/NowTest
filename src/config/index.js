...
export const GOOGLE_SIGN_IN_ANDROID_CLIENT_ID = '.apps.googleusercontent.com';

// You can find this value in the `ios/GoogleService-Info.plist` file
// Look for the `CLIENT_ID` value, which ends in `apps.googleusercontent.com`
export const GOOGLE_SIGN_IN_IOS_CLIENT_ID = '53134530844-nlmum7dvj6nf9969tn50s2m67954in0m.apps.googleusercontent.com';
